            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl">
                ...
                <div class="p-8">
                    <div class="mb-8 flex justify-between items-center">
                        <div>
                            <h3 class="text-lg font-bold text-gray-900">Update Task Details</h3>
                            <p class="text-sm text-gray-500">Modify the information below to update your task.</p>
                        </div>
                        <span class="text-xs font-mono text-gray-400">ID: #{{ $task->id }}</span>
                    </div>
